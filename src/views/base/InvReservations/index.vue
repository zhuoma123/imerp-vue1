        ...
        <el-form :inline="true" size="mini" :model="dataForm" @keyup.enter.native="getDataList()">
            <el-form-item>
                <el-input
                        ...
                        :placeholder="data.form.search.requirementDate"
                        clearable
                />
            </el-form-item>
            <el-form-item>
                <el-input
                        ...
                        :data-operate="dataFormOp.likeOps"
                        :placeholder="data.form.search.companyId"
                        clearable
                />
            </el-form-item>
                <el-form-item>
                    <el-input
                            ...
                            :data-operate="dataFormOp.likeOps"
                            :placeholder="data.form.search.productId"
                            clearable/>
                </el-form-item>
                    <el-form-item>
                        <el-input
                                ...
                                :data-operate="dataFormOp.likeOps"
                                :placeholder="data.form.search.warehouseId"
                                clearable/>
                    </el-form-item>
                    <el-form-item>
